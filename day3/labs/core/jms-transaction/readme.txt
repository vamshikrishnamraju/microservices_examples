...
then please enter this in the Karaf Console:
    ...
    osgi:install -s mvn:com.fusesource.training/jms-transaction/2010.07.12
...
3) Install it as feature (need to add the features URL ahead of time, please see the camel-exercises-features project)
    ...
    features:install camel-exercises-jms-transaction

In order to make the route do something you can copy an XML Payment file into '/camel-exercises/jms-transactions/in'
directory:

    cp src/test/resources/camel/in/VariousUSPayments.xml /camel-exercises/jms-transactions/in/