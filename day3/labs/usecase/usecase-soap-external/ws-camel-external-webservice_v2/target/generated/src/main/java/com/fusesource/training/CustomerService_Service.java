 ...
 * 2016-04-26T09:49:31.577+05:30
 * Generated source version: 2.6.0.redhat-60024
 * 
 */
@WebServiceClient(name = "CustomerService", 
                  wsdlLocation = "file:/C:/fuse/labs/camel-exercises/webservice/src/main/resources/META-INF/wsdl/CustomerService.wsdl",
...
public class CustomerService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/fuse/labs/camel-exercises/webservice/src/main/resources/META-INF/wsdl/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/fuse/labs/camel-exercises/webservice/src/main/resources/META-INF/wsdl/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
