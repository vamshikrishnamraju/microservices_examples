...
Java Mission Control 5.2.0 and Flight Recorder, but it is similar for JRMC.

1. Do a recording of the Allocator application, or simply open allocation.jfr.
2. Go to the Memory/Garbage Collections tab. Marvel at the frequency of garbage collections.
...
6. After fixing, there are almost no garbage collections anymore, except for the ones triggered to collect
   data for JFR. Check and compare the Memory | Garbage Collections tabs. 